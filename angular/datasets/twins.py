...
#         sample['label'] = label   
        sample= {'img1': sample['image0'], 'img2': sample['image1'], 'is_same': label, 'id0': ids[0], 'id1':[1]}
        if self.keypoints:
            sample['kp1']=keypoints[0]
            sample['kp2']=keypoints[1]
        return sample
...
#             sample['keypoints'] = kp#parse_keypoints(kp[view])
...
#                 sample['keypoints'] = np.array(sample['keypoints'])
        ...
        sample_ =  {'img': sample['image'], 'label': label, 'instance': view}
        if self.keypoints:
            sample_['kp']=kp
        return sample_
